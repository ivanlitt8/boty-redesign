    ...
    <div className="min-h-screen bg-white overflow-hidden">
      <main className="relative z-20 ">
        <nav className="pt-5 z-20 mx-0 sm:ml-10 w-full sm:w-40 items-center sm:items-start">
          <div className="-top-2 left-1/4 min-[636px]:left-0 absolute">
        ...
        <div className="mx-5 sm:mx-8 md:mx-16 lg:mx-24 xl:mx-10 2xl:mx-60 pt-0 sm:pt-40">
          <div className="flex flex-col justify-normal sm:justify-center pt-10 sm:pt-0 h-1/2vh sm:h-screen w-full">
            ...
            <p className="z-50 text-black mt-5 text-left text-sm sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl 2xl:text-5xl min-[450px]:w-3/4 min-[642px]:w-full w-full">
            ...
            <br></br>
            <div className="flex justify-center pt-0 md:pt-20 xl:pt-40">
